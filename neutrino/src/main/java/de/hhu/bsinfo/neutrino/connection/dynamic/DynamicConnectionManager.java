...
public class DynamicConnectionManager {
    ...
    private class UDInformationExchangeServer implements Runnable {

        private final ServerSocket serverSocket;

        UDInformationExchangeServer() throws IOException {
    ...
    private class UDInformationExchangeHandler implements Runnable {
        private final Socket socket;

        UDInformationExchangeHandler(Socket socket) {
            this.socket = socket;
        }

        @Override
        public void run() {
            //var remoteInfo = new UDRemoteInformationExchanger(socket).getRemoteInformation();
        }
    }
}
